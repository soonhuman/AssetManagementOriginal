	...
	void Start()
    {
		...
		var scenario05 = new Scenario()
		{
			...
			Texts = new List<string>()
			{
				...
				"君や私などの<color=#4169e1>屋敷の人間には古文書そのものの閲覧権限</color>と、\n<color=#4169e1>古文書一覧の中身の編集や閲覧の許可</color>を与えて欲しい。",
				"だが、 部外者には古文書やその一覧には何もできないようにしてほしい。\n権限の変更が終わったら最後には Hall に戻ってきてくれ。よろしく頼む。",
				"ミッション：部屋 OldBooks の中の書類の権限を変更し、\n　　　　　　部屋 Hall に移動せよ！開始",
				"まずは部屋の中にある物を確認します。コンソールにコマンドを入力して実行しましょう。",
				"部屋の中にあるものがわかりました。次は OldBooks の中にあるものの権限を変更します。",
