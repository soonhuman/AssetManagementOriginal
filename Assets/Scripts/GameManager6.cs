	...
	void Start()
    {
		var scenario06 = new Scenario()
		{
			...
			Texts = new List<string>()
			{
				...
				"ファイルの権限とは、<color=#4169e1>そのファイルやディレクトリを扱う\nユーザー毎に与えられる権限</color>のことだ。",
				"ファイルの権限には、<color=#4169e1>読み取り権限 (read) </color>、<color=#4169e1>書き込み権限 (write) </color>、\n<color=#4169e1>実行権限 (exec) </color>の3つがある。",
				"それぞれの権限は、ユーザー毎に許可するかどうかを決めることが出来る。\nこの権限を操作できるのが<color=#4169e1>chmodコマンド</color>だ。",
				"chmodは、\n<color=#4169e1>chmod 権限設定 (ファイル名やディレクトリ名)</color>\nで使うのは以前に学んだと思う。",
				"この権限設定をする際には、与える権限に対応した数字を用いる必要がある。",
				"権限設定に用いる数字には<color=#4169e1>4、2、1</color>の3種類がある。\n<color=#4169e1>4が読み取りの許可</color>、<color=#4169e1>2が書き込みの許可</color>、<color=#4169e1>1が実行の許可</color>を意味する。",
				...
				"だが、実はこれは3桁の数字というわけではなく、\n<color=#4169e1>3つのグループに異なる1桁の数字を与えている</color>のだ。",
